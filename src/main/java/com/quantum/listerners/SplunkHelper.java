...
public abstract class SplunkHelper {
	...
	public static void testStepStart(String stepName, String stepDesc, String stepNum) throws Exception {
		getCollector().startTransaction(stepName, stepDesc, stepNum);
	}
