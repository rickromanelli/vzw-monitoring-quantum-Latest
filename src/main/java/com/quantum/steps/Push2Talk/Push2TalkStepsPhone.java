...
public class Push2TalkStepsPhone {
	...
	public void iDeleteMessages(String device) throws Exception {
		...
		if (!pgs.textFind("No history exists", "15", "80")) {
			...
			/*
			 * Map<String, Object> params4 = new HashMap<>(); params4.put("label", "Yes");
			 * params4.put("timeout", "30"); params4.put("threshold", "100"); Object result4
	...
	//natural-language=true
		...
		params6.put("screen.top", "35%");
		params6.put("screen.left", "0%");
		params6.put("screen.height", "65%");
