...
Given I go to the device home screen
Then I initialize Gizmo app
Then Transaction "1 App Started?" description: "Can we see the word SouthLake on the home screen" SLA: "60000" - OCR Checkpoint: "WRONG TEXT" Timeout: "60" Threshold: "90"
