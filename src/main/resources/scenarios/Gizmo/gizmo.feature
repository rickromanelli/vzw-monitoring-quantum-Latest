...
Then Transaction "2 Child Located?" description: "Did Child show correct location?" SLA: "60000" - OCR Checkpoint: "Shadybrook Dr" or "Vienna Apple Rd" Timeout: "200" Threshold: "90"
...
#Then I search for Child Phone
Then Transaction "2 Child Located?" description: "Did Child show correct location?" SLA: "60000" - OCR Checkpoint: "Shadybrook Dr" or " Vienna Apple Rd" Timeout: "60" Threshold: "90"
