...
Then Transaction "2 Child Located?" description: "Did Child show correct location?" SLA: "60000" - OCR Checkpoint: "Shadybrook Dr" or " Keller Hicks" Timeout: "60" Threshold: "90"
