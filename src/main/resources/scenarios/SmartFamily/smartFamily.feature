...
Scenario: Smart_FamilyText_Limit
	...
	Then Transaction "1 Smart Family Launched?" description: "Opening Smart Family Parent App" SLA: "60000" - OCR Checkpoint: "Locating" Timeout: "60" Threshold: "80"
...
Scenario: Smart_FamilyCallLimit
	...
	Then I get device time on "DUT2" 
	Then I open Smart Family App on "DUT1"
	Then Transaction "1 Smart Family Launched?" description: "Opening Smart Family Parent App" SLA: "60000" - OCR Checkpoint: "Locating" Timeout: "60" Threshold: "90"
	#Then I tap to view child "1" on "DUT1"
...
Scenario: Smart_Family_CheckScreenTime
	...
	Then I open Smart Family App on "DUT1"
	Then I tap to view child "1" on "DUT1"
	Then SFScroll Transaction "1 Screen time?" description: "Checking for Chrome" SLA: "60000" - OCR Checkpoint: "Chrome" Timeout: "60" Threshold: "90"
	Then I tap to view child "1" on "DUT1"
