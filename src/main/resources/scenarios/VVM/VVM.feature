...
Scenario: VM2Text_Android
	...
	Then I open Voicemail App on "DUT1"
	Then Transaction: "1: Was message received?" Description: "Check for message with text" SLA: "30000" - Image checkpoint: "PUBLIC:Prod/VVM/LG_v20_MWI_With_Text.png" Timeout: "20" Threshold: "90"
	Then I click on voicemail message on "DUT1"
	Then Transaction: "2: Message text accurate?" Description: "check text for accuracy" SLA: "30000" - OCR checkpoint: "test voicemail 12345678" Timeout: "30" Threshold: "90"
