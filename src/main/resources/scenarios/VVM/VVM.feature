...
Scenario: VM2Text_Android
	...
	Then I open Voicemail App on "DUT1"
	Then Transaction: "1: Was message received?" Description: "Check for message with text" SLA: "30000" - Image checkpoint: "PUBLIC:messageIconGalaxyA12.png" or Image checkpoint: "ddddd" Timeout: "60" Threshold: "90"
