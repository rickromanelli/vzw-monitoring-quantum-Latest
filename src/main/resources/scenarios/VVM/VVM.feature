...
Scenario: VM2Text_Android
	...
	Then I open Voicemail App on "DUT1"
	Then Transaction: "1: Was message received?" Description: "Check for message with text" SLA: "30000" - Image checkpoint: "PUBLIC:Prod/VVM/LG_v20_MWI_With_Text.png" Timeout: "40" Threshold: "90"
