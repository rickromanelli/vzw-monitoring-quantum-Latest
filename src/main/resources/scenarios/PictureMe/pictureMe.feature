...
Scenario: Caller_ID
	...
	Then Transaction: "Did PictureMe image appear?" on "DUT2" Description: "Checking to see if Image was shown on DUT2" SLA: "5000" - Image checkpoint: "PUBLIC:historyBtnA12.png" Timeout: "60" Threshold: "85"
