...
Scenario: Caller_ID
	...
	Then Transaction: "Did PictureMe image appear?" on "DUT2" Description: "Checking to see if Image was shown on DUT2" SLA: "60000" - Image checkpoint: "PUBLIC:Prod/CallerNameID/CallerID-MotoZsmall.png" Timeout: "60" Threshold: "85"
